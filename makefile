...
linux-debug32: gmake-linux
	make -R -C ../.build/linux/gcc/rdebug/projects config=debug32
linux-release32: gmake-linux
	make -R -C ../.build/linux/gcc/rdebug/projects config=release32
linux-debug64: gmake-linux
	make -R -C ../.build/linux/gcc/rdebug/projects config=debug64
linux-release64: gmake-linux
	make -R -C ../.build/linux/gcc/rdebug/projects config=release64
linux: linux-debug32 linux-release32 linux-debug64 linux-release64

gmake-mingw-gcc:
	$(GENIE) --file=genie/genie.lua --gcc=mingw-gcc gmake
mingw-gcc-debug32: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rdebug/projects config=debug32
mingw-gcc-release32: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rdebug/projects config=release32
mingw-gcc-debug64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rdebug/projects config=debug64
mingw-gcc-release64: gmake-mingw-gcc
	make -R -C ../.build/windows/mingw-gcc/rdebug/projects config=release64
...
mingw-clang-debug32: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rdebug/projects config=debug32
mingw-clang-release32: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rdebug/projects config=release32
mingw-clang-debug64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rdebug/projects config=debug64
mingw-clang-release64: gmake-mingw-clang
	make -R -C ../.build/windows/mingw-clang/rdebug/projects config=release64
...
../.build/osx/gcc/rdebug/projects:
	$(GENIE) --file=genie/genie.lua --gcc=osx gmake
osx-debug64: ../.build/osx/gcc/rdebug/projects
	make -C ../.build/osx/gcc/rdebug/projects config=debug64
osx-release64: ../.build/osx/gcc/rdebug/projects
	make -C ../.build/osx/gcc/rdebug/projects config=release64
